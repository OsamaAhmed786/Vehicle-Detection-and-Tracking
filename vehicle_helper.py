...
class vehicleHelper:
    def __init__(self,args):
        print ("vehicleHelper class initilization is completed")
        self.color_space = args.color_space
        self.orient = args.orient
        self.pix_per_cell = args.pix_per_cell
        self.cell_per_block = args.cell_per_block
        self.hog_channel = args.hog_channel
        self.spatial_size = args.spatial_size
        self.hist_bins = args.hist_bins
        self.spatial_feat = args.spatial_feat
        self.hist_feat = args.hist_feat
        self.hog_feat = args.hog_feat
